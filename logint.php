      ...
      $row;
        while($row=mysqli_fetch_assoc($result)){
            ...
            if ($pass == $row['password']){ 
                ...
                $showError = "Invalid Credentials 000 ";
            }
        }
...
<html lang="en">
  ...
  <body background="https://img1.goodfon.com/wallpaper/nbig/3/40/kompas-compass-mehanizm.jpg">
    ...
    ?>
<div class="cont mt-5">
    <center><h1 style="margin: 30px;">Login to Travel Buffs</h1></center>
    ...
    <div  class="container my-4">
        <center><h3 style="color: white;">If You are New User Then : <a href="signup.php" class="btn btn-primary">Sign up</a></h4></h3></center>  
