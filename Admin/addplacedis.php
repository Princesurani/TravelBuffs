    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <div class="row">
            <h1 class="card-title ml10">Add Place information</h1>
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">

                  <form class="forms-sample" action="addplacedis.php" method="post">
        ...
        if (isset($_POST['btnsubmit'])) {
          ...
          $qr = "INSERT INTO `places`(`img`, `title`, `site`, `direction`, `desc1`, `desc2`, `timevisit`, `care`, `plan`, `todo`, `transp`, `map`) VALUES ('$img','$title','$site','$dir','$desc1','$desc2','$timevisit','$care','$plan','$todo','$transp','$map')";
